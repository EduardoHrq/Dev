    ...
    <div className={inter.className}>
      <div className='w-full h-full flex'>
        ...
        <div className="w-3/4 pt-4 pb-6 pr-5 flex flex-col gap-5">
          ...
          <textarea className="h-3/5 rounded-xl bg-zinc-800 text-white outline-none p-5 resize-none"></textarea>

          <div className="flex justify-evenly items-center gap=5">
            <button className="py-4 px-32 rounded-xl text-black bg-red-500 hover:bg-red-400 transition-colors">Limpar</button>
